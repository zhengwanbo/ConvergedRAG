  ...
  translation: {
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Проведите тест поиска, чтобы проверить, может ли ConvergedRAG находить нужный контент для LLM.',
      Parse: 'Обработать',
      dataset: 'Набор данных',
      ...
      similarityThresholdTip:
        'ConvergedRAG использует взвешенное сходство ключевых слов в комбинации с косинусным сходством векторов или реранкингом. Этот параметр устанавливает порог сходства между запросом пользователя и фрагментами. Фрагменты с оценкой ниже порога будут исключены из результатов. По умолчанию порог установлен на 0.2.',
      ...
      uploadDescription:
        'Поддерживает одиночную или пакетную загрузку. Для локального ConvergedRAG: максимальный размер загрузки 1GB, до 32 файлов. Для demo.ragflow.io: максимальный размер загрузки 10MB, до 128 файлов.',
      chunk: 'Фрагмент',
      bulk: 'Пакетно',
      cancel: 'Отмена',
      close: 'Закрыть',
      ...
      rerankTip: `Опционально. Если оставить пустым, ConvergedRAG будет использовать комбинацию сходства ключевых слов и векторов. Выбор модели реранкинга заменит векторное сходство на оценку реранкинга.`,
      topK: 'Топ-K',
...
<ul>
  ...
  <li>Авто-ключевые слова требуют значительных ресурсов LLM.</li>
    ...
    chat: {
      ...
      betaError:
        'Сначала получите API ключ ConvergedRAG на странице системных настроек.',
      searching: 'Поиск...',
      parsing: 'Обработка',
      uploading: 'Загрузка',
    ...
    fileManager: {
      ...
      uploadTitle: 'Перетащите файлы для загрузки',
      uploadDescription:
        'Поддерживает одиночную или пакетную загрузку. Ограничения: локальный ConvergedRAG - 1GB/32 файла; demo.ragflow.io - 10MB/128 файлов.',
