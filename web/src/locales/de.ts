export default {
  ...
  <p>Siehe https://ragflow.io/docs/dev/use_tag_sets für Details.</p>
    ...
    chat: {
      ...
      betaError:
        'Bitte erwerben Sie zuerst einen ConvergedRAG-API-Schlüssel auf der Systemeinstellungsseite.',
      searching: 'Suche...',
      parsing: 'Analysiere',
      uploading: 'Hochladen',
