...
class Dealer:
    ...
    def rerank(self, sres, query, tkweight=0.3,
        ...
        # modify for oracle23ai, to get the vector data.
    ...
    def retrieval(self, question, embd_mdl, tenant_ids, kb_ids, page, page_size, similarity_threshold=0.2,
        ...
        if rerank_mdl and sres.total > 0:
            ...
            lower_case_doc_engine = os.getenv('DOC_ENGINE', 'oracle')
            if lower_case_doc_engine in ["elasticsearch","opensearch", "oracle"]:
